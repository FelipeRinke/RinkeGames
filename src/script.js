...
const noticiasDB = [
    // --- PáGINA 1 ---
    {
        ...
        <ul style="list-style-type: circle;">
            ...
            <li>Dois pares de botões traseiros opcionais.
                <ul style="list-style-type: circle;">
    ...
    },
    {
        ...
        <li><strong>Audio:</strong> Essencial com Áudio Espacial 7.1 ou tecnologias como Dolby Atmos para localização precisa.</li>
        </ul>
        `
    },
    {
